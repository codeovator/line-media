...
<?php get_header( ); ?>
	<div id="container" class="">
		<?php if(isset($_SESSION['subscribed']) && $_SESSION['subscribed'] == 'yes' ) {
			unset($_SESSION['subscribed']);
		 ?>
		<div class="text-restrict" style="text-align:center;" id="success-msg">
			Congratulations! Your registration was successful.You may now login using the password that was emailed to you.
		</div>
		<br/>
		<?php }elseif(isset($_SESSION['subscribed']) && $_SESSION['subscribed'] == 'no'){?>
		<div class="text-restrict" style="text-align:center;" id="success-msg">
